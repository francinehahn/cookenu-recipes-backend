...
recipeRouter.get("/following", (req, res) => recipeController.getRecipesFromTheAccountsTheUserFollows(req, res))
recipeRouter.get("/user", (req, res) => recipeController.getRecipesRegisteredByTheUser(req, res))
